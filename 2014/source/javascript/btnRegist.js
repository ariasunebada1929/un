function btnRegist_Click(){
	...
	for(n = 1; n <=maxdate; n++){
		...
		if(KihonStart !=""){
			if (!KihonStart.match(/^[0-9][0-5][0-9]+$|[0][0-9][0-5][0-9]+$|[1][0-9][0-5][0-9]+$|[2][0-4][0-5][0-9]+$/)) {
				strMessage += n +"日の基本勤務時間・出社に正しい時刻を入力してください\n";
			}
		}
		if(KihonEnd !=""){
			if (!KihonEnd.match(/^[0-9][0-5][0-9]+$|[0][0-9][0-5][0-9]+$|[1][0-9][0-5][0-9]+$|[2][0-4][0-5][0-9]+$/)) {
				strMessage += n +"日の基本勤務時間・退社に正しい時刻を入力してください\n";
			}
		}
		if(JissekiStart !=""){
			if (!JissekiStart.match(/^[0-9][0-5][0-9]+$|[0][0-9][0-5][0-9]+$|[1][0-9][0-5][0-9]+$|[2][0-4][0-5][0-9]+$/)) {
				strMessage += n +"日の実績勤務時間・出社に正しい時刻を入力してください\n";
			}
		}
		if(JissekiEnd !=""){
			if (!JissekiEnd.match(/^[0-9][0-5][0-9]+$|[0][0-9][0-5][0-9]+$|[1][0-9][0-5][0-9]+$|[2][0-4][0-5][0-9]+$/)) {
				strMessage += n +"日の実績勤務時間・退社に正しい時刻を入力してください\n";
			}
		}
		if(JissekiRest !=""){
			if (!JissekiRest.match(/^[0-9][0-5][0-9]+$|[0][0-9][0-5][0-9]+$|[1][0-9][0-5][0-9]+$|[2][0-4][0-5][0-9]+$/)) {
				strMessage += n +"日の実績勤務時間・休憩に正しい時刻を入力してください\n";
			}
		}
		if(Zangyo !=""){
			if (!Zangyo.match(/^[0-9][0-5][0-9]+$|[0][0-9][0-5][0-9]+$|[1][0-9][0-5][0-9]+$|[2][0-4][0-5][0-9]+$/)) {
